...
class நம்மாத்திரைListener(மாத்திரைListener):
    ...
    def enterஆய்தக்குறுக்கம்(self, ctx:மாத்திரைParser.ஆய்தக்குறுக்கம்Context):
        self.seq.append(['ஃ', 'ஆய்தக்குறுக்கம்' , மாத்திரை_பட்டியல்['ஆய்தக்குறுக்கம்'] ])
        ...
        if உயிர்மெய் == 'றி':
            self.seq.append(['றி', 'உயிர்மெய்க்குறில்' , மாத்திரை_பட்டியல்['உயிர்மெய்க்குறில்'] ])
        elif உயிர்மெய் == 'டீ':
            self.seq.append(['டீ', 'உயிர்மெய்நெடில்' , மாத்திரை_பட்டியல்['உயிர்மெய்நெடில்'] ])
    ...
    def enterமகரக்குறுக்கம்_தனிமொழி(self, ctx:மாத்திரைParser.மகரக்குறுக்கம்_தனிமொழிContext):
        ...
        self.seq.append([உயிர்மெய், 'மெய்' , மாத்திரை_பட்டியல்['மெய்'] ])   
        self.seq.append(['ம்', 'மகரக்குறுக்கம்' , மாத்திரை_பட்டியல்['மகரக்குறுக்கம்'] ])
    ...
    def enterமகரக்குறுக்கம்_புணர்மொழி(self, ctx:மாத்திரைParser.மகரக்குறுக்கம்_புணர்மொழிContext):
        ...
        self.seq.append(['ம்', 'மகரக்குறுக்கம்' , மாத்திரை_பட்டியல்['மகரக்குறுக்கம்'] ])
        self.seq.append([உயிர்மெய், 'உயிர்மெய்க்குறில்' , மாத்திரை_பட்டியல்['உயிர்மெய்க்குறில்'] ])  
    ...
    def enterகுற்றியலிகரம்_தனிமொழி(self, ctx:மாத்திரைParser.குற்றியலிகரம்_தனிமொழிContext):
        ...
        self.seq.append(['மி', 'குற்றியலிகரம்' , மாத்திரை_பட்டியல்['குற்றியலிகரம்'] ])
        self.seq.append(['யா', 'உயிர்மெய்நெடில்' , மாத்திரை_பட்டியல்['உயிர்மெய்நெடில்'] ])   
    ...
    def enterகுற்றியலிகரம்_புணர்மொழி(self, ctx:மாத்திரைParser.குற்றியலிகரம்_புணர்மொழிContext):
        ...
        self.seq.append([உயிர்மெய், 'குற்றியலிகரம்' , மாத்திரை_பட்டியல்['குற்றியலிகரம்'] ])
