...
அறிவிக்கும் கூறு.
    ...
    முடிவு.பிழைகள்    # விதி மீறல்கள்: பிழை(விதி, அடி, சீர், விவரம்) — விதிகள்: பாகுபாட்டுப்பிழை, அடி_எண்ணிக்கை,
                     #   அடி_சீர்_எண்ணிக்கை, ஈற்றடி_சீர்_எண்ணிக்கை, ஈற்றுச்சீர்_பிழை, கனிச்சீர்_தடை, நாலசைச்சீர்_தடை, வெண்டளை_பிழை
...
def _சீர்விவரம்(சீர்ctx, parser) -> Optional[சீர்விவரம்]:
    ...
    if _விதிப்பெயர்(சீர்முடிச்சு, parser) == 'நாலசை':      # நாலசை -> உள்ளே உண்மைச் சீர் (தேமாந்தண்பூ ...)
    ...
    for எண், அடி in enumerate(அடிகள், start=1):
        ...
        for இடம், சீர் in enumerate(அடி, start=1):
            if சீர்.வாய்பாடு in தளைக்கூறு.கனிச்சீர்:
                ...
                பிழைகள்.append(பிழை('நாலசைச்சீர்_தடை', எண், இடம், f"நாலசைச்சீர் வெண்பாவில் வராது: {சீர்.வாய்பாடு} ({சீர்.பதம்})"))
