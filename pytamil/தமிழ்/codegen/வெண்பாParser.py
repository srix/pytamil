...
class வெண்பாParser ( Parser ):
    ...
    ruleNames =  [ "வெண்பா", "குறள்_வெண்பா", "சிந்தியல்_வெண்பா", "நேரிசை_வெண்பா", 
                   ...
                   "கூவிளங்காய்", "நாள்", "மலர்", "காசு", "பிறப்பு", "நேர்", 
                   "நிரை", "ஒற்று", "குறில்", "நெடில்" ]
    ...
    def நேர்(self):
        ...
        self.enterRule(localctx, 48, self.RULE_நேர்)
        try:
            self.state = 251
            self._errHandler.sync(self)
    ...
    def நிரை(self):
        ...
        self.enterRule(localctx, 50, self.RULE_நிரை)
        try:
            self.state = 267
            self._errHandler.sync(self)
    ...
    def ஒற்று(self):
        ...
        self.enterRule(localctx, 52, self.RULE_ஒற்று)
    ...
    def குறில்(self):
        ...
        self.enterRule(localctx, 54, self.RULE_குறில்)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 271
    ...
    def நெடில்(self):
        ...
        self.enterRule(localctx, 56, self.RULE_நெடில்)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 273
