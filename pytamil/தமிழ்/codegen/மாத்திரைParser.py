...
def serializedATN():
    with StringIO() as buf:
        ...
        buf.write("\3\f\3\r\3\r\3\r\3\16\3\16\3\17\3\17\3\17\2\2\20\2\4\6")
        buf.write("\b\n\f\16\20\22\24\26\30\32\34\2\7\3\2\3\7\3\2\b\16\3")
        buf.write("\2\17 \3\2\"(\5\2\25\33\35\36 !\2Q\2\36\3\2\2\2\4+\3\2")
        buf.write("\2\2\6\62\3\2\2\2\b\66\3\2\2\2\n>\3\2\2\2\f@\3\2\2\2\16")
        buf.write("C\3\2\2\2\20E\3\2\2\2\22G\3\2\2\2\24I\3\2\2\2\26K\3\2")
        buf.write("\2\2\30N\3\2\2\2\32Q\3\2\2\2\34S\3\2\2\2\36\"\5\4\3\2")
        buf.write("\37!\5\6\4\2 \37\3\2\2\2!$\3\2\2\2\" \3\2\2\2\"#\3\2\2")
        buf.write("\2#%\3\2\2\2$\"\3\2\2\2%&\5\b\5\2&\3\3\2\2\2\',\5\16\b")
        buf.write("\2(,\5\20\t\2),\5\26\f\2*,\5\30\r\2+\'\3\2\2\2+(\3\2\2")
        buf.write("\2+)\3\2\2\2+*\3\2\2\2,\5\3\2\2\2-\63\5\22\n\2.\63\5\26")
        buf.write("\f\2/\63\5\30\r\2\60\63\5\24\13\2\61\63\5\f\7\2\62-\3")
        buf.write("\2\2\2\62.\3\2\2\2\62/\3\2\2\2\62\60\3\2\2\2\62\61\3\2")
        buf.write("\2\2\63\7\3\2\2\2\64\67\5\26\f\2\65\67\5\22\n\2\66\64")
        buf.write("\3\2\2\2\66\65\3\2\2\2\67\t\3\2\2\289\5\16\b\29:\5\26")
        buf.write("\f\2:?\3\2\2\2;<\5\26\f\2<=\5\26\f\2=?\3\2\2\2>8\3\2\2")
        buf.write("\2>;\3\2\2\2?\13\3\2\2\2@A\5\22\n\2AB\5\32\16\2B\r\3\2")
        buf.write("\2\2CD\t\2\2\2D\17\3\2\2\2EF\t\3\2\2F\21\3\2\2\2GH\t\4")
        buf.write("\2\2H\23\3\2\2\2IJ\7!\2\2J\25\3\2\2\2KL\5\22\n\2LM\5\16")
        buf.write("\b\2M\27\3\2\2\2NO\5\22\n\2OP\5\20\t\2P\31\3\2\2\2QR\t")
        buf.write("\5\2\2R\33\3\2\2\2ST\t\6\2\2T\35\3\2\2\2\7\"+\62\66>")
        return buf.getvalue()
...
class மாத்திரைParser ( Parser ):
    ...
    RULE_குறிலிணை = 4
    RULE_உயிரளபெடை = 5
    RULE_உயிர்க்குறில் = 6
    RULE_உயிர்நெடில் = 7
    RULE_மெய் = 8
    RULE_ஆய்தம் = 9
    RULE_உயிர்மெய்க்குறில் = 10
    RULE_உயிர்மெய்நெடில் = 11
    RULE_உயிரளபெடை_எழுத்து = 12
    RULE_ஒற்றளபெடை = 13

    ruleNames =  [ "மாத்திரை", "மொழிமுதல்", "மொழியிடை", "மொழியிறுதி", "குறிலிணை", 
                   "உயிரளபெடை", "உயிர்க்குறில்", "உயிர்நெடில்", "மெய்", 
                   "ஆய்தம்", "உயிர்மெய்க்குறில்", "உயிர்மெய்நெடில்", "உயிரளபெடை_எழுத்து", 
                   "ஒற்றளபெடை" ]
    ...
    def உயிர்க்குறில்(self):
        ...
        self.enterRule(localctx, 12, self.RULE_உயிர்க்குறில்)
    ...
    def உயிர்நெடில்(self):
        ...
        self.enterRule(localctx, 14, self.RULE_உயிர்நெடில்)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 67
    ...
    def மெய்(self):
        ...
        self.enterRule(localctx, 16, self.RULE_மெய்)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 69
    ...
    def ஆய்தம்(self):
        ...
        self.enterRule(localctx, 18, self.RULE_ஆய்தம்)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 71
    ...
    def உயிரளபெடை_எழுத்து(self):
        ...
        self.enterRule(localctx, 24, self.RULE_உயிரளபெடை_எழுத்து)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 79
    ...
    def ஒற்றளபெடை(self):
        ...
        self.enterRule(localctx, 26, self.RULE_ஒற்றளபெடை)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 81
