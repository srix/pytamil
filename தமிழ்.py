...
def தொடர்மொழி_ஆக்கு(நிலைமொழி, வருமொழி):
    ...
    if len(நிலைமொழி_எழுத்துக்கள்) == 2 and \
        tamilutf8.splitMeiUyir(நிலைமொழி_எழுத்துக்கள்[0])[1] in குரில் and \
    ...
    elif கடையெழுத்து(நிலைமொழி) in மெய்யெழுத்து and \
         முதலெழுத்து(வருமொழி) in உயிரெழுத்து: 
         தொடர்மொழி = மெய்யின்_மேல்_உயிர்_வந்து_ஒன்றுதல்(நிலைமொழி, வருமொழி)
...
def மெய்யின்_மேல்_உயிர்_வந்து_ஒன்றுதல்(நிலைமொழி, வருமொழி):
    நிலைமொழி_எழுத்துக்கள் = tamilutf8.get_letters(நிலைமொழி)
    வருமொழி_எழுத்துக்கள் = tamilutf8.get_letters(வருமொழி)
